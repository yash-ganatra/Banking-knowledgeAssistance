...
class ControllerParser:
    ...
    def parse_single_file(self, file_path: str) -> Dict[str, Any]:
        """
        Parse a single PHP controller file.
        Used by the ingestion pipeline for incremental updates.
        
        Args:
            file_path: Absolute path to a .php controller file
        
        Returns:
            Dict with controller data, or empty dict if parsing fails
        """
    ...
    def _extract_function_calls(self, body: str) -> List[Dict[str, str]]:
        ...
        # Framework/utility classes to exclude (not user-defined actions)
        ignored_classes = {
