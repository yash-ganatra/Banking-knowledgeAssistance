...
<style type="text/css">
    #kitDetailsHistoryTables{width: 100%!important; }
                    ...
                    <div class="card table-top">
                        <div class="card-block table-border-style card-block-padding">
                            <div class="table-responsive">
                                <table class="table table-custom" id="kitDetailsHistoryTables">
                                    <thead>
                                        <tr>
                                            <th>Request ID</th>
                                            <th>Branch ID</th>
...
$(document).ready(function(){
    ...
    $('#export-excel').on("click",function(e){
        ...
        $("#kitDetailsHistoryTables").DataTable().page.len( -1 ).draw();
        if($("#kitDetailsHistoryTables").DataTable().page.len() == -1){
            setTimeout(function(){
                $("#kitDetailsHistoryTables").DataTable().button('0').trigger();
    ...
    getDKitTable('/delightadmin/kitdetailshistorytable','kitDetailsHistoryTables',tableRemainingHeight);
