...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#sentDate').dateRangePicker({
            ...
            getUserApplications('/archival/userapplications','userApplicationsTable',tableRemainingHeight);
        });

        $("body").on("change",".customerName, .applicationStatus, #customerType",function(){
            getUserApplications('/archival/userapplications','userApplicationsTable',tableRemainingHeight);
        });
        getUserApplications('/archival/userapplications','userApplicationsTable',tableRemainingHeight);
    });
