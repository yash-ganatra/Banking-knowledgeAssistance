...
class DsaMasterController extends Controller
{
     ...
     public function __construct()
    {
         if(Cookie::get('token') != ''){
            ...
            if(!$isAutherized)
            {
                ...
                $saveuserlog = CommonFunctions::createUserLogDirect('ChannelId/DsaMasterController','dsamastertable','Unauthorized attempt detected by '.$this->userId,'','','1');
    ...
    public function dsamastertable()
    {
       ...
       return view('channelid.oaotable')->with('tables',$tables);
    }
    ...
    public function addoaocolumndata(Request $request)
    {
        try{
            ...
            return view('channelid.addoaotable')->with('branchlists',$branchlists)
